...
describe('resource monitors', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.monitors.create({ eventTypes: ['tweet.new', 'tweet.reply'], username: 'elonmusk' });
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.monitors.create({ eventTypes: ['tweet.new', 'tweet.reply'], username: 'elonmusk' });
  });
