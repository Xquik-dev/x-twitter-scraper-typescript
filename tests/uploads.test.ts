import fs from 'fs';
import type { ResponseLike } from 'x-twitter-scraper/internal/to-file';
import { toFile } from 'x-twitter-scraper/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('x-twitter-scraper/core/uploads');
    await expect(
