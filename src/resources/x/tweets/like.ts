...
export class Like extends APIResource {
   ...
   * ```
   */
  create(id: string, params: LikeCreateParams, options?: RequestOptions): APIPromise<LikeCreateResponse> {
   ...
   * ```
   */
  delete(id: string, params: LikeDeleteParams, options?: RequestOptions): APIPromise<LikeDeleteResponse> {
    const { 'Idempotency-Key': idempotencyKey, ...body } = params;
...
export interface LikeCreateResponse {
   ...
   */
  account: LikeCreateResponse.Account | null;
   ...
   */
  billing: LikeCreateResponse.Billing;
   ...
   */
  nextAction: LikeCreateResponse.NextAction | null;
   ...
   */
  request: LikeCreateResponse.Request;

  /**
   * Confirmed result produced by the write, when available.
   */
  result: LikeCreateResponse.Result | null;
   ...
   */
  target: LikeCreateResponse.Target | null;
...
export namespace LikeCreateResponse {
  /**
   * Connected account selected for the write.
   */
...
export interface LikeDeleteResponse {
   ...
   * Connected account selected for the write.
   */
  account: LikeDeleteResponse.Account | null;
   ...
   * credit ledger. Pending or failed writes are not charged.
   */
  billing: LikeDeleteResponse.Billing;
   ...
   * Exact follow-up an API client or agent should perform.
   */
  nextAction: LikeDeleteResponse.NextAction | null;
   ...
   * Stable fingerprint and sanitized payload for replay checks.
   */
  request: LikeDeleteResponse.Request;

  /**
   * Confirmed result produced by the write, when available.
   */
  result: LikeDeleteResponse.Result | null;
   ...
   * Existing X resource targeted by the write, when applicable.
   */
  target: LikeDeleteResponse.Target | null;
...
export namespace LikeDeleteResponse {
  /**
   * Connected account selected for the write.
   */
  export interface Account {
