...
export interface RetweetCreateResponse {
   ...
   */
  account: RetweetCreateResponse.Account | null;
   ...
   */
  nextAction: RetweetCreateResponse.NextAction | null;
   ...
   */
  result: RetweetCreateResponse.Result | null;
   ...
   */
  target: RetweetCreateResponse.Target | null;
...
export interface RetweetDeleteResponse {
   ...
   * Connected account selected for the write.
   */
  account: RetweetDeleteResponse.Account | null;
   ...
   * credit ledger. Pending or failed writes are not charged.
   */
  billing: RetweetDeleteResponse.Billing;
   ...
   * Exact follow-up an API client or agent should perform.
   */
  nextAction: RetweetDeleteResponse.NextAction | null;
   ...
   * Stable fingerprint and sanitized payload for replay checks.
   */
  request: RetweetDeleteResponse.Request;

  /**
   * Confirmed result produced by the write, when available.
   */
  result: RetweetDeleteResponse.Result | null;
   ...
   * Existing X resource targeted by the write, when applicable.
   */
  target: RetweetDeleteResponse.Target | null;
...
export namespace RetweetDeleteResponse {
  /**
   * Connected account selected for the write.
   */
  export interface Account {
